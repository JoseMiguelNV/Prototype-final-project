...
namespace MODE_LINKS
{
    public partial class Trabajos : Form
    {
        ...
        //PARA MARCAS DE AGUA EN TEXTBOX
        ...
        private void dataGridViewTrabajos_RowHeaderMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            try
            {
                ...
                txbIDVehiculo.Text = dt.Rows[e.RowIndex][2].ToString();
                txbIDProyecto.Text = dt.Rows[e.RowIndex][3].ToString();
                txbIDHerramienta.Text = dt.Rows[e.RowIndex][4].ToString();
                txbDescripcion.Text = dt.Rows[e.RowIndex][5].ToString();
                txbIDTrabajo.Enabled = false;
                btnAnyadirTrabajo.Enabled = false;
            }
            catch (Exception ex)
            {
        ...
        private void btnAnyadirTrabajo_Click(object sender, EventArgs e)
        {
            ...
            trabajo.id_herramienta = txbIDHerramienta.Text;
        ...
        {
            btnAnyadirTrabajo.Enabled = true;
            txbIDTrabajo.Text = "";
            txbIDTecnico.Text = "";
            txbIDVehiculo.Text = "";
            txbIDProyecto.Text = "";
